...
export const PRACTITIONERS_DATA = [
  {
    ...
    "modalities": [
      "Acceptance and Commitment Therapy (ACT) / Cognitive Behavioural Therapy (CBT) / Schema Therapy / Eye Movement Desensitisation and Reprocessing (EMDR) / Internal Family Systems (IFS) / Parts Work - Informed / Trauma-Informed Care",
    ...
    "pronouns": "She/Her",
    "billing_types": "Medicare Rebate (Chronic Disease Management Plan);  Medicare Rebate (Eating Disorder Treatment Plan);  Medicare Rebate (Mental Health Care Plan);  National Disability Insurance Scheme (NDIS) Plan Managed;  National Disability Insurance Scheme (NDIS) Self Managed;  Self Funded (Private paying);  Third Party Funded ( EG Genwest);  Medicare Rebate",
    "languages": "English",
    "spare_time": "Spend time with my two cats, go hiking, running or walking, play piano.",
    "pap_clinician": "",
    "after_hours": "",
    "religions_groups": "Athiest;  Catholic;  Christianity;  Jewish",
    ...
    "style": "Active Listener, Animal Lover, Calm, Conscientiousness, Female, Humorous, Sensitive and Gentle"
  },
  {
    "id": 25,
    "name": "Rebekah Barson",
  ...
  },
  {
    ...
    "pronouns": "He/Him",
    "billing_types": "Medicare Rebate (Chronic Disease Management Plan);  Medicare Rebate (Mental Health Care Plan);  National Disability Insurance Scheme (NDIS) Plan Managed;  National Disability Insurance Scheme (NDIS) Self Managed;  Self Funded (Private paying);  Third Party Funded ( EG Genwest);  Medicare Rebate",
    "languages": "English",
    "spare_time": "",
    "pap_clinician": "",
    "after_hours": "",
  ...
  },
  {
    ...
    "modalities": [
      "Attachment Based Therapy;  Couples Counselling;  Emotionally Focused Therapy (EFT);  Internal Family Systems (IFS) - Informed;  Mindfulness;  Person/ Client centred Therapy;  Play Therapy;  Psychodynamic Psychotherapy;  Somatic Psychotherapy;  Trauma Informed Recovery based practice",
      "Psychodynamic Therapy",
      "Humanistic / Person-Centred Therapy",
      "Attachment-Based Therapy",
      "Internal Family Systems (IFS) / Parts Work - Certified Level 1",
  ...
  },
  {
    ...
    "alert": "",
    "presentations": [
      "ADD and ADHD;  Agoraphobia;  Bereavement;  Bipolar Disorder;  Burnout;  Career transition;  Chronic Pain and illness;  Clinical Depression (Major Depressive Disorder);  Eating Disorders;  Family;  General Adaptation Disorder (Adjustment Disorder);  Generalized Anxiety Disorder (GAD);  Life Transitions;  Obsessive-Compulsive Disorder (OCD);  Panic Disorder & Panic Attacks;  Perfectionism;  Post Traumatic Stress Disorder (PTSD);  Self esteem;  Social anxiety disorder / Social Phobia;  Workplace stress",
      "Agoraphobia",
      "Bereavement",
      "Bipolar Disorder",
      "Burnout",
    ...
    "modalities": [
      "Acceptance and Commitment Therapy (ACT);  Coaching;  Cognitive Behaviour Therapy (CBT);  Couples Counselling;  Exposure and Response Prevention Therapy ( ERP) for OCD;  Mindfulness;  Motivational Interviewing (MI);  Schema Therapy;  Sex Therapy;  Solution Focused Therapy",
      "Acceptance and Commitment Therapy (ACT)",
      "Cognitive Behavioural Therapy (CBT)",
      "Exposure and Response Prevention (ERP)",
      "Schema Therapy"
    ],
    "client_types": "Individual;  Couples;  Family",
    "age_range": "12 Yrs +",
    "therapist_type": "Psychologist",
    ...
    "weekly_availability": [],
    "fortnightly_availability": [],
    "style": "A parent, Creative, Female, Humorous, Openness"
  },
  {
    "id": 21,
    "name": "Niloo Danaei",
    ...
    "presentations": [
      ...
      "Culturally and linguistically diverse clients",
      "LGBTQIA+ affirmative therapy",
      "I’m particularly passionate about working with clients who experience dysthymia, MDD and depression"
    ],
    "modalities": [
    ...
    "pap_clinician": "",
    "after_hours": "",
    "religions_groups": "Athiest;  Islam",
  ...
  },
  {
    ...
    "modalities": [
      "Cognitive Behaviour Therapy (CBT);  Couples Counselling;  Eye Movement Desensitisation and Reprocessing (EMDR);  Schema Therapy",
      "Cognitive Behavioural Therapy (CBT)",
      "Schema Therapy",
      "Eye Movement Desensitisation and Reprocessing (EMDR)",
      "Internal Family Systems (IFS) / Parts Work - Informed",
    ...
    "pap_clinician": "Yes",
    "after_hours": "",
    "religions_groups": "Buddhism;  Catholic",
  ...
  },
  {
    ...
    "pronouns": "She/Her",
    "billing_types": "Self Funded (Private paying);  Third Party Funded ( EG Genwest);  WorkSafe;  Employer Funded (Employee Assistance Program)",
    "languages": "English\nSpanish",
  ...
  },
  {
    ...
    "modalities": [
      "Acceptance and Commitment Therapy (ACT);  Attachment Based Therapy;  Cognitive Behaviour Therapy (CBT);  Mindfulness;  Motivational Interviewing (MI)",
      "Acceptance and Commitment Therapy (ACT)",
      "Cognitive Behavioural Therapy (CBT)",
      "Dialectical Behaviour Therapy (DBT)",
      "Schema Therapy"
  ...
  },
  {
    ...
    "pronouns": "He/Him",
    "billing_types": "Employer Funded (Employee Assistance Program);  Medicare Rebate (Chronic Disease Management Plan);  Medicare Rebate (Mental Health Care Plan);  National Disability Insurance Scheme (NDIS) Plan Managed;  National Disability Insurance Scheme (NDIS) Self Managed;  Self Funded (Private paying);  Third Party Funded ( EG Genwest);  WorkSafe",
    "languages": "",
    "spare_time": "Be in nature, Be active: Run + Cycle + Surf, Read, Garden, Yoga, Socialise with friends, Play with my 2 year old nephew.",
    "pap_clinician": "",
    "after_hours": "",
    "religions_groups": "Athiest;  Buddhism;  Catholic;  Christianity;  Hinduism;  Islam;  Jewish",
  ...
  },
  {
    ...
    "pap_clinician": "",
    "after_hours": "",
    "religions_groups": "Athiest;  Buddhism;  Catholic;  Christianity",
  ...
  },
  {
    ...
    "pronouns": "",
    "billing_types": "Medicare Rebate (Chronic Disease Management Plan);  Medicare Rebate (Eating Disorder Treatment Plan);  Medicare Rebate (Mental Health Care Plan);  Self Funded (Private paying);  Third Party Funded ( EG Genwest)",
  ...
  },
  {
    ...
    "modalities": [
      "Acceptance and Commitment Therapy (ACT); Cognitive Behavioural Therapy (CBT); Solution-Focused Brief Therapy (SFBT); Trauma-Informed Care",
      "Acceptance and Commitment Therapy (ACT)",
      "Cognitive Behavioural Therapy (CBT)",
      "Solution-Focused Brief Therapy (SFBT)",
      "Trauma-Informed Care"
  ...
  },
  {
    ...
    "pronouns": "She/Her",
    "billing_types": "Medicare Rebate (Chronic Disease Management Plan);  Medicare Rebate (Mental Health Care Plan);  Self Funded (Private paying);  Third Party Funded ( EG Genwest);  Medicare Rebate",
    "languages": "English",
    ...
    "style": "A parent, Active Listener, Compassionate, Conscientiousness, Creative, Empathetic, Existential, Extravert, Gentle, Female, Introvert, Non Judgemental, Openness, Sensitive and Gentle, Talkative, Warm"
  },
  {
    "id": 14,
